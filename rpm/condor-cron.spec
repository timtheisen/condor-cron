...
%{_sysconfdir}/condor-cron/config.d/condor_ids
...
cat <<__END__ > /etc/condor-cron/config.d/condor_ids
# This file is automatically generated.  Do not edit.
# If you want to override the UID/GID, create a file called
# /etc/condor-cron/config.d/condor_ids_override
# and add the CONDOR_IDS line there.

CONDOR_IDS = $CC_UID.$CC_GID
__END__
...
%changelog
* Mon Feb 11 2019 Brian Lin <blin@cs.wisc.edu> 1.1.4-1
- Explicitly set ALLOW_READ to support 8.9.0 (SOFTWARE-3538)

* Tue Jul 18 2017 Mátyás Selmeci <matyas@cs.wisc.edu> 1.1.3-1
- Don't use GSI authz (SOFTWARE-2812)
- Don't make /etc/condor-cron/config.d/condor_ids a config file;
  users should be adding a condor_ids_override file
